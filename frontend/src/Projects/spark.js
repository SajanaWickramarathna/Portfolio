          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-[#C9D1D9] text-base md:text-lg mb-10 leading-relaxed font-light">
                System for managing volunteers, organizations, and events, featuring authentication, role-based access, group chat, and a fully responsive design.
              </p>
...
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Group Chat with Socket.io</span></span></li>
                </ul>
              </div>
