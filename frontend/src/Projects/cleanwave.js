...
import { RiFlowChart, RiFileCodeLine } from "react-icons/ri";
import { motion } from "framer-motion";
import Footer from "../components/footer";
import CleanWave from "../assets/cleanWave.png";

const techs = [
  { label: "Java (Servlets)", icon: <FaJava className="text-red-600" /> },
  { label: "JSP", icon: <RiFileCodeLine className="text-yellow-500" /> },
  ...
  { label: "MVC", icon: <RiFlowChart className="text-purple-400" /> },
];
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-[#58A6FF] mb-3">
              CleanWave Laundry System
            </h2>
            <p className="text-[#C9D1D9] text-sm md:text-base mb-4 max-w-md mx-auto md:mx-0">
              Java-based laundry system using Servlets & JSP with MVC
              architecture. Features dashboards, order tracking, and invoice
              management.
            </p>

            <ul className="text-[#8B949E] text-sm mb-4 list-disc list-inside space-y-1 max-w-md mx-auto md:mx-0">
              <li>Real-time order & invoice tracking</li>
              <li>Role-based dashboards</li>
              <li>MySQL backend</li>
              <li>Well-structured MVC pattern</li>
            </ul>
