            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <div className="w-full max-w-3xl bg-black/20 rounded-2xl p-6 md:p-8 border border-white/5 mb-12 shadow-inner">
                ...
                <ul className="text-[#8B949E] text-sm md:text-base space-y-4">
                  <li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1">✦</span><span>Live Tracking with Socket.IO</span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1">✦</span><span>Map & Route Integration (Leaflet, OpenStreetMap, OSRM, Nominatim)</span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1">✦</span><span>API Authentication & Responsive UI Development</span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1">✦</span><span>Team Collaboration & Git Version Control</span></li>
