...
const techs = [
  ...
  { label: "Socket.io", icon: <SiSocketdotio className="text-white" /> },
  { label: "Leaflet", icon: <SiLeaflet className="text-green-600" /> },
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-[#C9D1D9] text-base md:text-lg mb-10 leading-relaxed font-light">
                Worked in a team to develop a MERN-based delivery management platform for rural entrepreneurs. Responsible for implementing interactive map features, route visualization, and real-time delivery tracking to improve last-mile logistics operations.
              </p>
              ...
              <div className="w-full bg-[#0D1117]/80 rounded-2xl p-6 md:p-8 border border-white/5 mt-auto shadow-inner hover:border-white/10 transition-colors">
                ...
                <ul className="text-[#8B949E] text-sm md:text-base space-y-4">
                  <li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Live Tracking with Socket.IO</span></span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Map & Route Integration (Leaflet, OpenStreetMap, OSRM, Nominatim)</span></span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>API Authentication & Responsive UI Development</span></span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Team Collaboration & Git Version Control</span></span></li>
                </ul>
              </div>
          ...
          >
            ...
            <div className="bg-[#161B22]/60 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-white/20 transition-all duration-500 shadow-lg">
               ...
               <div className="relative z-10 flex flex-col items-center">
                 ...
                 <a
                    href="https://github.com/Seneth-Jayashan/Rural-Link"
                    target="_blank"
