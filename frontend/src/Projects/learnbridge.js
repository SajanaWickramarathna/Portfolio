          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-[#C9D1D9] text-base md:text-lg mb-10 leading-relaxed font-light">
                Worked in a team to develop a full-stack learning management platform that enables students to access educational content, attend virtual classes, and utilize knowledge resources through a centralized web application.
              </p>
              ...
              <div className="w-full bg-[#0D1117]/80 rounded-2xl p-6 md:p-8 border border-white/5 mt-auto shadow-inner hover:border-white/10 transition-colors">
                ...
                <ul className="text-[#8B949E] text-sm md:text-base space-y-4">
                  <li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Course, Lesson, and Subject Management</span></span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Zoom Integration for Virtual Learning Sessions</span></span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Cloudinary Integration for File and Media Handling</span></span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Knowledge Base Management System</span></span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>REST API Development & Database Design</span></span></li>
                </ul>
              </div>
          ...
          >
            ...
            <div className="bg-[#161B22]/60 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-white/20 transition-all duration-500 shadow-lg">
               ...
               <div className="relative z-10 flex flex-col items-center">
                 ...
                 <a
                    href="https://github.com/Seneth-Jayashan/LearnBridge"
                    target="_blank"
