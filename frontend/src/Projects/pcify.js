        ...
        <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          >
            ...
            <p className="text-[#C9D1D9] text-sm md:text-base mb-4 max-w-md mx-auto md:mx-0">
              PCIFY is a shopping app for PC components developed using Kotlin
              and XML layouts. It offers a smooth user experience for browsing,
              selecting, and purchasing PC parts.
            </p>

            <ul className="text-[#8B949E] text-sm mb-4 list-disc list-inside space-y-1 max-w-md mx-auto md:mx-0">
              <li>Built with Kotlin and XML layouts for Android</li>
              <li>Comprehensive PC component catalog</li>
              <li>User-friendly shopping interface</li>
            </ul>
