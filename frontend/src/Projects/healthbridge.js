          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <p className="text-[#C9D1D9] text-base md:text-lg mb-10 leading-relaxed font-light">
                Worked as part of a development team to build a scalable telemedicine platform featuring online consultations, appointment management, secure payments, and AI-assisted healthcare services. Responsible for implementing the video consultation and prescription management modules.
              </p>
              ...
              <div className="w-full bg-[#0D1117]/80 rounded-2xl p-6 md:p-8 border border-white/5 mt-auto shadow-inner hover:border-white/10 transition-colors">
                ...
                <ul className="text-[#8B949E] text-sm md:text-base space-y-4">
                  <li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Developed Real-Time Video Consultation Module</span></span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Developed Digital Prescription Management System</span></span></li>
<li className="flex items-start gap-3 text-left"><span className="text-[#58A6FF] mt-1 font-bold">»</span><span><span className="text-[#58A6FF] mt-1">✦</span><span>Docker & Kubernetes for Containerized Deployment</span></span></li>
                </ul>
              </div>
          ...
          >
            ...
            <div className="bg-[#161B22]/60 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-white/20 transition-all duration-500 shadow-lg">
               ...
               <div className="relative z-10 flex flex-col items-center">
                 ...
                 <a
                    href="https://github.com/Seneth-Jayashan/HealthBridge"
                    target="_blank"
